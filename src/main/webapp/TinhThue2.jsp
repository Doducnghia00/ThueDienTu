...
<head>
    ...
    <script src="js/tinhthue2.js"></script>
		...
		<div>
			<form class="form-2" id  = "form-2" action = "TinhThue" method = "post">
			   <div class="form-group" >
			        ...
			        <input autofocus type = "text" name="tongthunhap" id = "tongthunhap" class="form-control" value="${tongthunhap}">
			        <br><br>
			        <label>Số người phụ thuộc:</label>
			        <input type = "text" name="songuoiphuthuoc" id= "songuoiphuthuoc" class="form-control" value="${songuoiphuthuoc}">
			        <br><br>
			    ...
			    <input type = "submit" class="btn btn1 btn-custom border" value="Tính Thuế" style = "margin-top:10px; margin-bottom:10px" ><br>
			    <p id = text></p>
		    </form>
		    <div>
