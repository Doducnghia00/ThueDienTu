		...
		<div class="container"
			...
			<main class="form-signin">
				<form action="DangKy" method="post">
					<h1>Đăng ký</h1>                    
					<div>
						<label>Tên đăng nhập (Số CMT/CCCD) </label> <input autofocus
							class="form-control" id="username" name="username"
							placeholder="Nhập số CMT/CCCD" required>
					</div>
					<div>
					...
					<div>
						<label>Ngày sinh </label> <input class="form-control" type="date"
							id="floatingInput3" name="ngaysinh" placeholder="dd/mm/yyyy" required>
					</div>
					<div>
						<label>Số điện thoại </label> <input class="form-control"
							id="floatingInput4" name="sodienthoai" placeholder="Nhập số điện thoại" required>
					</div>
					<div>
						<label>Email </label> <input class="form-control"
							id="floatingInput5" name="email" placeholder="Nhập email của bạn" required>
					</div>
					<div>
						<label>Địa chỉ liên hệ: </label> <input class="form-control"
							id="floatingInput5" name="diachi" placeholder="Nhập địa chỉ của bạn" required>
					</div>
					<div>
					...
					<div class="checkbox mb-3">
						<label> <input type="checkbox" required value="remember-me">
					...
					<button id="btn-huy" style="margin-top: 10px; margin-left: 46%;"
						...
						<a href="./index.jsp" class="Huy">Hủy</a>
					</button>
